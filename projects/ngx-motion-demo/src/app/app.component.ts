...
import { MotionOnePresenceComponent } from '../directives/motion-one-presence.component';
...
export class AppComponent implements AfterViewInit {
  ...
  // This method is called when the router outlet activates a component
  onActivate(component: any, motionPresence: MotionOnePresenceComponent): void {
    console.log('Router outlet activated component:', component);
   // motionPresence.setCurrentComponent(component);
  }
